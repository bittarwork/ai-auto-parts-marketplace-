...
Search results are displayed in a responsive grid of product cards. Each card shows the product image, name, price, stock status, and compatibility indicator if the user has a registered vehicle.
